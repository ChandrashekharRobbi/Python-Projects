...
RED = "\033[1;31m"
RESET = "\033[0m"
name = "Chandrashekhar Robbi"
print(f"{GREEN}Hey {name} All the best Do bunch of problems today 👍🏻💖{RESET}")
...
#                     commit_message = random.choice(s)
                ...
                k = f"{RED}You haven't made changes in the functions so your commit will be added after {n - Handler.counter} changes in your file:({RESET}" if (n - Handler.counter) > 0 else f"{GREEN}Your commit will be added now:){RESET}"
